...
/**
 * Created by wangyuwei on 17/3/2.
 */
...
public class SPUtils {
     ...
     * 保存在手机里面的文件名
     */
    public static final String FILE_NAME = "blancat_app_sp";
    ...
    public static Object get(String key, Object defaultObject) {
        SharedPreferences sp = BaseApp.getInstance().getSharedPreferences(FILE_NAME,
