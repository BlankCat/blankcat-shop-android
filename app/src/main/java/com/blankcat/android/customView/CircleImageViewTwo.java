package com.blankcat.android.customView;
...
/**
 * Created by jyf on 18/3/16.
 */

public class CircleImageViewTwo extends android.support.v7.widget.AppCompatImageView {
    //缩放类型
    ...
    public CircleImageViewTwo(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CircleImageViewTwo, defStyle, 0);
        //通过TypedArray提供的一系列方法getXXXX取得我们在xml里定义的参数值；
        // 获取边界的宽度
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CircleImageViewTwo_border_width, DEFAULT_BORDER_WIDTH);
        // 获取边界的颜色
        mBorderColor = a.getColor(R.styleable.CircleImageViewTwo_border_color, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(R.styleable.CircleImageViewTwo_border_overlay, DEFAULT_BORDER_OVERLAY);
