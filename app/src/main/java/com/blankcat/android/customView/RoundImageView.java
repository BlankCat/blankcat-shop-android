...
import com.blankcat.android.utils.DensityUtils;
...
public class RoundImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private int roundHeight = DensityUtils.dp2px(BaseApp.getInstance(), 5);
    private int roundWidth = DensityUtils.dp2px(BaseApp.getInstance(), 5);
